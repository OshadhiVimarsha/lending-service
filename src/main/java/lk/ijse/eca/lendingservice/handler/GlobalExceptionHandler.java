package lk.ijse.eca.lendingservice.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleLendingNotFound(
            LendingNotFoundException ex, HttpServletRequest request) {
        log.warn("Lending not found: {}", ex.getMessage());
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.NOT_FOUND, "Lending Not Found", ex.getMessage(), request.getRequestURI());
        return problemResponse(HttpStatus.NOT_FOUND, problem);
    }

    @ExceptionHandler(DuplicateLendingException.class)
    public ResponseEntity<ProblemDetail> handleDuplicateLending(
            DuplicateLendingException ex, HttpServletRequest request) {
        log.warn("Duplicate lending: {}", ex.getMessage());
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.CONFLICT, "Duplicate Lending", ex.getMessage(), request.getRequestURI());
